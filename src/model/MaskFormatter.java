...
public class MaskFormatter {
     ...
     * @param textField
     */
    public MaskFormatter(JFXTextField textField) {
        this.textField = textField;
    }   
    public MaskFormatter(TextField texto) {
        this.texto = texto;
    }
     ...
     * @param showMask
     */
    public void addComponente(JFXTextField field, int maskType, boolean showMask) {
    ...
    public void addComponente(TextField field, int maskType, boolean showMask) {
        MaskFormatter formatter = new MaskFormatter(texto);
        formatter.setMask(maskType);
        if (showMask) {
            formatter.showMask();
        }
     ...
     * @param showMask
     */
    public void addComponente(JFXDatePicker datePicker, int maskType, boolean showMask) {
     ...
     public void addComponente(DatePicker data, int maskType, boolean showMask) {
        MaskFormatter formatter = new MaskFormatter(data);
        formatter.setMask(maskType);
        if (showMask) {
            formatter.showMask();
        }
